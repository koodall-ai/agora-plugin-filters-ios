...
//  KoodallAgoraFilters
//
//  Created by Koodall on 20.07.21.
//
...
class ViewController: UIViewController {
  ...
  @IBOutlet weak var effectSelectorView: KoodallEffectSelectorView!
...
// MARK: - KoodallFilterPlugin interactions
extension ViewController {
  ...
  /// To control KoodallEffectPlayer via json methods refer to this method
